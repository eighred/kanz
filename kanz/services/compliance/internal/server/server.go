// Package server is the compliance service's HTTP surface — liveness/readiness
// probes and the metrics endpoint. It carries no business logic; enforcement
// flows over the bus.
package server
...
// Readiness gates traffic: starts NOT ready, flips once the monitor is
// subscribed; shutdown clears it.
