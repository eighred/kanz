...
"
  ...
  for c in kanz-risk kanz-books; do
    ...
    case "$c" in
      ...
      kanz-books) tables="ledger_entries ledger_snapshots outbox custody_statements custody_runs custody_breaks custody_actions"; db="$BOOKS_DB_NAME" ;;
