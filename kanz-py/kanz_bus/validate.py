...
Enforces the invariants in ``kanz-schemas/docs/envelope-policy.md`` §7 plus
the per-class rules from ``docs/event-class-rules.md``. ``Producer.publish``
runs this after stamping; consumers should run it on receive too — the
